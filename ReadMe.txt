Your about me page MUST be your index.html that file is 100% needed in order to successfully push to GitHub (aka DO NOT CHANGE THAT FILE NAME). I have also set-up demo pages for other content that is required as well as a CSS and JavaScript Page. make changes
